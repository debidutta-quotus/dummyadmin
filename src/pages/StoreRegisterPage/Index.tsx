...
export default function StoreRegisterNew() {
  ...
  const getFieldClassName = (fieldName: string) => {
    return `store-register-page-field ${fieldErrors.has(fieldName) ? 'error' : ''}`;
  };

  const renderBasicInfo = () => (
    <div className="store-register-page-form-content">
      <h2>Basic Information</h2>
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Store Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Brand Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Business Type *</label>
          <select
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Cuisine Type *</label>
          <select
  ...
  const renderContactInfo = () => (
    <div className="store-register-page-form-content">
      ...
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">First Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Last Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Email *</label>
          <input
            type="email"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Contact Number *</label>
          <input
            type="number"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Password *</label>
          <input
            type="password"
  ...
  const renderAddress = () => (
    <div className="store-register-page-form-content">
      <h2>Address</h2>
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group full-width">
          <label className="store-register-page-label">Street Address *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Floor (optional)</label>
          <input
            type="number"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Neighbourhood (optional)</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">City *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Region *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Country *</label>
          <select
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Postal Code *</label>
          <input
            type="text"
  ...
  const renderBusinessDetails = () => (
    <div className="store-register-page-form-content">
      ...
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Number of Locations *</label>
          <input
            type="number"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Website URL (optional)</label>
          <input
            type="url"
        ...
        <div className="store-register-page-form-group full-width">
          <label className="store-register-page-label">Description (optional) </label>
          <textarea
  ...
  const renderOperatingHours = () => (
    <div className="store-register-page-form-content">
      ...
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Opening Time *</label>
          <input
            type="time"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Closing Time *</label>
          <input
            type="time"
        ...
        <div className="store-register-page-form-group full-width">
          <label className="store-register-page-label">Operating Days *</label>
          <div
            className={`store-register-page-checkbox-group ${fieldErrors.has('operatingDays') ? 'error' : ''}`}
          >
            {days.map((day) => (
              <label key={day} className="store-register-page-checkbox-label">
                <input
                  type="checkbox"
                  checked={formData.storeInfo.operatingDays.includes(day)}
                  onChange={() => handleDayToggle(day)}
                  className="store-register-page-checkbox"
                />
                <span>{day}</span>
              </label>
            ))}
  ...
  const renderDeliveryPartners = () => (
    <div className="store-register-page-form-content">
      <div className="store-register-page-delivery-partners-header">
        <h2 className="store-register-page-delivery-partners-title">Delivery partners</h2>
        <span className="store-register-page-delivery-partners-count">
          {formData.storeInfo.deliveryPartnerID.length} selected
        </span>
      </div>
      <p className="store-register-page-devivery-partners-paragraph">
        Select your prefered delivery partners *
      </p>
      <div
        className={`store-register-page-delivery-partner-grid ${fieldErrors.has('deliveryPartnerID') ? 'error' : ''}`}
      >
        {deliveryPartners.map((partner) => (
          <div
            key={partner.id}
            className={`store-register-page-delivery-partner-card ${
              formData.storeInfo.deliveryPartnerID.includes(partner.id) ? 'selected' : ''
            }`}
            onClick={() => handleDeliveryPartnerToggle(partner.id)}
          >
            <div className="store-register-page-delivery-partner-logo-container">
              <img
                src={partner.logo}
                alt={`${partner.id} logo`}
                className="store-register-page-delivery-partner-logo"
              />
            </div>
          </div>
        ))}
  ...
  const renderBankDetails = () => (
    <div className="store-register-page-form-content">
      ...
      <div className="store-register-page-grid">
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Bank Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Account Holder Name *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">Account Number *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">IFSC Code *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">IBAN *</label>
          <input
            type="text"
        ...
        <div className="store-register-page-form-group">
          <label className="store-register-page-label">SWIFT Code *</label>
          <input
            type="text"
  ...
  return (
    <div className="store-register-page-main-container">
      <div className={`store-register-page ${isDarkMode ? 'dark' : ''}`}>
        <div className="store-register-page-header">
          <h1>Register Your Store</h1>
          <p>Connect your POS system with food delivery partners</p>
        </div>

        <div className="store-register-page-mobile-step-indicator">
          <div className="store-register-page-mobile-step-title">{steps[currentStep].title}</div>
          <div className="store-register-page-mobile-step-description">
            {steps[currentStep].description}
          </div>
          <div className="store-register-page-progress-bar">
            <div
              className="store-register-page-progress-fill"
              style={{ width: `${((currentStep + 1) / steps.length) * 100}%` }}
            ></div>
          </div>
        </div>

        <div className="store-register-page-container">
          <div className="store-register-page-sidebar">
            <div className="store-register-page-steps-list">
              {steps.map((step, index) => (
                <div
                  key={step.title}
                  className={`store-register-page-step-item ${index === currentStep ? 'active' : ''} ${
                    index < currentStep ? 'completed' : ''
                  }`}
                >
                  <div className="store-register-page-step-indicator">
                    {index < currentStep && (
                  ...
                  <div className="store-register-page-step-content">
                    <h3>{step.title}</h3>
          ...
          <div className="store-register-page-main" ref={formRef}>
            <form className="store-register-page-form" autoComplete="off">
              {(() => {
                switch (currentStep) {
                  case 0:
              ...
              <div className="store-register-page-button-group">
                <button
                  type="button"
                  onClick={handleSkip}
                  className="store-register-page-button-secondary"
                >
                  Skip
                </button>
                {currentStep > 0 && (
                ...
                <button
                  type="button"
                  onClick={nextStep}
                  className="store-register-page-button-primary"
                >
