...
export const OutletManagementNavigation = ({ toggleOutletSubmenu, outletSubmenuOpen }: OutletManagementNavigationProps) => {
    ...
    return (
        <li className="sidebar-submenu-container">
            ...
            <div
                ref={submenuRef}
                className={`sidebar-submenu ${outletSubmenuOpen ? 'open' : ''}`}
            >
